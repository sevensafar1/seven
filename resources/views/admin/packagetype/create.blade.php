    ...
    <div class="row g-4">
        <div class="col-sm-12 col-xl-12">
            <div class="bg-light rounded h-100 p-4">
                ...
                <form id="packageTypeForm" action="{{route('package-type/save')}}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Package Name</label>
                        <input type="text" class="form-control" id="name" name="package_name">
...
<script>
    $(document).on('submit', 'form#packageTypeForm', function(event) {
