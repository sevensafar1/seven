    ...
    <div class="row g-4">
        ...
        <div class="col-sm-12 col-xl-12">
            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                <form id="hotelFormUpdate" action="{{ route('hotel/update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="hidden" class="form-control" id="update_id" name="update_id" value="{{ $hotel->slug }}">

                            <input type="hidden" class="form-control" id="hotel_id" name="hotel_id" value="{{ $hotel->id }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="location" name="address" value="{{ $hotel->address }}">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" id="saved_state" value="{{ $hotel->state }}">
                        <input type="hidden" id="saved_city" value="{{ $hotel->city }}">
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="mrp" name="mrp" value="{{ $hotel->mrp }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text"  class="form-control" id="distance" name="distance"  value="{{ $hotel->distance }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="suggested" name="suggested">
                                ...
                                <option value="0" {{ $hotel->suggested_hotel == 0 ? 'selected' : '' }}>----- Select -------</option>

                                <option value="1" {{ $hotel->suggested_hotel == 1 ? 'selected' : '' }}>Suggested</option>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <option value="">----- Select------- </option>
                                    <option value="EP" {{ $hotel->meals_plan == 'EP' ? 'selected' : '' }}>Only Room</option>
                                    <option value="CP" {{ $hotel->meals_plan == 'CP' ? 'selected' : '' }}>Breakfast Included</option>
                                    <option value="MAP" {{ $hotel->meals_plan == 'MAP' ? 'selected' : '' }}>Breakfast +Lunch/Dinner</option>
                                    <option value="AP" {{ $hotel->meals_plan == 'AP' ? 'selected' : '' }}>Breakfast +Lunch+Dinner</option>
                    ...
                    <div id="imagePreviewContainer" class="mt-2 d-flex flex-wrap">
                        ...
                        @php
                            ...
                            $existingImages = \App\Models\HotelImage::where('hotel_id', $hotel->id)->get();
                        ...
                        @if($existingImages->count())
                            ...
                            @foreach($existingImages as $image)
                                ...
                                <div class="image-preview d-flex align-items-center mb-2 position-relative" id="preview-{{ $image->id }}">
                                    ...
                                    <img src="{{ asset('public/images/hotels/' . $image->images) }}" alt="Image Preview" class="img-thumbnail" style="width: 100px; height: auto; margin-right: 10px;">
                    ...
                    <div id="bannerImagePreviewContainer" class="mt-2">
                        @if($hotel->banner_image)
                            <div class="image-preview d-flex align-items-center mb-2 position-relative" id="preview-banner">
                                <img src="{{ asset('public/images/hotels/' . $hotel->banner_image) }}" alt="Banner Image Preview" class="img-thumbnail" style="width: 100px; height: auto; margin-right: 10px;">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text"  class="form-control" id="hotel_tags" name="hotel_tags" value="{{$hotel->hotel_tags}}">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="productDescription" class="form-control" name="description">{!! $hotel->about !!}</textarea>
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        window.setTimeout(function() {
                            ...
                            window.location.href = "{{ route('hotel/list') }}"; // Redirect after 1 second
