    ...
    <div class="row g-4">
        ...
        <div class="col-sm-12 col-xl-12">
            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                <form id="resortForm" action="{{route('resort/save')}}" method="POST" enctype="multipart/form-data">
                ...
                @csrf    
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <label for="exampleInputEmail1" class="form-label">Resort Name</label>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('submit', 'form#resortForm', function(event) {
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        window.setTimeout(function() {
                            ...
                            window.location.href = "{{route('resort/list')}}"; 
        ...
        $(document).on('click', '.remove-image', function() {
            const previewId = $(this).data('id');
            $(`#preview-${previewId}`).remove();
            // $('#' + previewId).remove(); // Remove the selected image preview
        });
